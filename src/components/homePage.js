    ...
    >
      <div className="table min-h-screen">
        <div className="table-cell align-middle text-center w-[97vw]  mx-auto">
          ...
          <button className="md:text-md text-sm bg-transparent hover:black text-white hover:text-white py-2 px-4 border border-white hover:border-transparent rounded">
            Our Services
          </button>
        </div>
      </div>
