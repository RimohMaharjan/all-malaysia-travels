...
const Representation = () => {
  ...
  return (
    <div>
        <div className="max-w-screen-2xl mx-auto lg:grid grid-cols-3  min-h-screen 2xl:px-0 md:px-10 px-5">
          <div className="table">
          ...
          <div className="col-span-2 md:py-0 py-12 mx-auto table">
            ...
            {partners ? (
              <div className="grid md:grid-cols-3 grid-cols-2 gap-20 items-center justify-items-center">
                {partners.map((item) => (
                  <img
                    className="md:max-h-44 max-h-20 inline object-contain "
                    src={item.logo}
                    alt={item.alt}
                  />
                ))}
